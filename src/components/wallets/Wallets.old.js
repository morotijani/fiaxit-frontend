...
function Wallets() {
    ...
    const wallets = [
    {
      ...
      value: "$2,300.45",
      change: "+2.1%",
      logo: <img src="https://cryptologos.cc/logos/bitcoin-btc-logo.png?v=024" alt="Bitcoin" />,
    },
    {
      name: "Ethereum",
      symbol: "ETH",
        ...
        async function fetchWallets() {
            try {
                ...
                const jobs = storeWallets.map(async (w) => {
                    ...
                    const infoPromise = jsonGet(`convert/coinmarketcap/info/${symbol.toLowerCase()}`);
                                ...
                                >
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-muted small">{w.symbol} • {w.address}</div>
                                        </div>
                                    </div>

                                    <div className="text-end">
                                        <div className="fw-semibold">{w.value}</div>
            ...
            >
                <div className="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div className="text-muted small">{wallet.symbol}</div>
                    </div>
                </div>

              <div className="text-end">
                <div className="fw-semibold">{wallet.value}</div>
                <div
                  className={`small ${
